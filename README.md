...
![2D simulation without barrier](caso_2D/without_barrier.gif)

![2D simulation with barrier](caso_2D/cronificacion_final.gif)
...
![2D simulation maze](caso_2D/simulacion_laberinto_final.gif)
